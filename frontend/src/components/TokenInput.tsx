		...
		<div className='bg-[#23483c] rounded-lg p-4 my-2'>
			...
			<div className='flex items-center gap-4'>
				<input
					...
					readOnly={readOnly}
					className='flex-1 w-full bg-transparent text-white text-3xl font-medium placeholder:text-white/40 focus:outline-none ring-0 border-none p-0 appearance-none'
